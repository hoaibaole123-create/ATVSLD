...
function getGenAI(): GoogleGenAI {
  ...
  if (!apiKey) {
    throw new Error("Chưa cấu hình GEMINI_API_KEY. Vui lòng thêm biến môi trường GEMINI_API_KEY trong Vercel Project Settings -> Environment Variables.");
  }
  if (!aiClient) {
...
1. KIỂM TRA VI PHẠM AN TOÀN VỆ SINH LAO ĐỘNG (ATVSLĐ & BHLĐ/PPE):
   - Không đội mũ bảo hộ, mũ để sai chỗ (để trên bàn/tủ/ghế).
